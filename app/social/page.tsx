...
export const metadata = {
  ...
  description:
    "Official VANTH community links. Always verify links through this page to stay safe.",
};
...
const links = [
  ...
  },
  {
    label: "Discord",
    description:
      "Join the community. Ask questions, get whitelist help, connect with the team.",
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="text-center mb-12">
        ...
        <p className="text-white/40 max-w-lg mx-auto leading-relaxed">
          This page is the single source of truth for all VANTH links. Bookmark
          it and always verify before clicking any link claiming to be VANTH.
        </p>
      </div>
      ...
      <div className="space-y-3">
        {links.map((link) => (
          <div
            key={link.label}
            className="border border-white/8 rounded bg-white/3 p-5"
          >
      ...
      <div className="mt-8 p-4 rounded bg-white/3 border border-white/8 text-center">
        <p className="text-white/35 text-sm">
          <span className="text-white/60 font-semibold">Remember:</span> The
          VANTH team will never DM you first on any platform. If someone claims
          to be from VANTH and messages you, it is a scam.
        </p>
      </div>
    </div>
  );
